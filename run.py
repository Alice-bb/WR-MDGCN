import os
import sys
from lib.schedulers import AdaptiveLearningRateScheduler
...
from model.WRMDGC import WRMDGC as Network
...
args.add_argument('--model', default='WRMDGC', type=str)
...
args.add_argument('--diffusion_steps', default=config['model']['diffusion_steps'], type=int)
...
# args.add_argument('--use_cluster', default=config['model']['use_cluster'], type=eval)


#args.add_argument('--update_interval', default=config['model']['update_interval'], type=eval)
...
# args.add_argument('--lr_decay_steps', default=config['train']['lr_decay_steps'], type=float)
